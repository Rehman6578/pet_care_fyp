...
class _AddTaxiServiceState extends State<AddTaxiService> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Taxi Service', style: TextStyle(fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
      body: Padding(
                  ...
                  Obx(() =>
                      DropDownMultiSelect(
                        ...
                        onChanged: (value) {
                          ...
                          for (var value1 in petController.selectPetseatbelt
                              .value) {
                            petController.selectePetSeatBelt.value =
                            "${petController.selectePetSeatBelt
                                .value}$value1"; // interpolation
                          }
                        },
