...
class VeterinaryDocScreen extends StatefulWidget {
  const VeterinaryDocScreen({super.key});
        ...
        child: Column(
          children: [
            Stack(
              children: [
                Container(
                  child: const Image(image: AssetImage(img3),
                    fit: BoxFit.cover,
                    width: 420,
                    height: 420,),
                ),
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.white,
                        border: const Border(top: BorderSide(color: white,width: 1),
                            ...
                            children: <Widget>[
                              const Column(
                                children: [
                                  ...
                                  Text('10 years of experience',style: TextStyle(color: Colors.grey,fontSize: 12),),
                                  SizedBox(height: 10,),
                                  Row(
                                    children: [
                                      CircleAvatar(
                                          radius: 13,
                                          child: Image(image: AssetImage(walet),width: 30,)),

                                      Text('1.5km'),
                                      SizedBox(width: 20,),
                                      CircleAvatar(
                                          radius: 13,
                                          child: Image(image: AssetImage(map),width: 15,)),
                                      Image(image: AssetImage(dollar),width: 15,),
                                      Text('20'),
                                    ],
                                  )
                                ],
                        ...
                        children: [
                          ...
                          Row(
                            children:[
                              const CircleAvatar(
                                radius:10,
                                  child: Image(image:AssetImage(step),width:15,color: blue,)),
                              ...
                              const Icon(Icons.arrow_forward_ios_sharp,size: 10,color: Colors.grey,)
                            ]
                          ),
                          const SizedBox(height:25 ,),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width:40 ,),
                                    Text('29', style: TextStyle(fontWeight: FontWeight.bold)),
                                    SizedBox(width:40 ,),
                      ...
                      Column(
                        children: [
                          ListTile(
                              ...
                              title: Text("Repeated participant and winner of the International Conferences, reports on the topic: “Iatrogenic pathology in urology”, “Foreign bodies of the gastrointestinal tract in small domestic animals”",
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w400,
                                  )
                          ...
                          ListTile(
                            leading: Image(image: AssetImage(dot)),
                            title: Text("From 1998 to 2001, he was the chief physician of the\n Equus veterinary medicine clinic.",
                                style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                                )
                ...
                const Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Icon(Icons.keyboard_arrow_right_sharp,size: 17,color: blue,)
                    ],
                  ),
                ),
                const SizedBox(height: 15,),
                        ...
                        Card(
                          ...
                          child: Column(
                            children: [
                              ...
                              const Padding(
                                padding: EdgeInsets.only(bottom: 8.0,left: 8,top:8),
                                child: Row(
                                  children: [
                                    Text('a verified review',style: TextStyle(fontSize: 10),),
                                    SizedBox(width: 5,),
                                    CircleAvatar(
                                        radius: 5,
                                        backgroundColor: Colors.green,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text('10 years of experience',style: TextStyle(color: Colors.grey),),
                                          SizedBox(width: 10,),
                                          CircleAvatar(child: Image(image: AssetImage(map),width: 20,)),

                                          Text('1.5km'),
                                          SizedBox(width: 10,),
                                          CircleAvatar(child: Image(image: AssetImage(walet),width: 30,)),
                                          Image(image: AssetImage(dollar),width: 15,),
                                          Text('20'),
